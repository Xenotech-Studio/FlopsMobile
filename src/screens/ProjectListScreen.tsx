...
function createProjectListStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    projectName: { fontSize: 16, fontWeight: '600', color: c.textPrimary },
    projectDesc: {
...
export function ProjectListScreen() {
  ...
  const styles = useMemo(() => createProjectListStyles(colors), [colors]);
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.empty}>
                <Ionicons name="folder-open-outline" size={56} color={colors.placeholder} />
